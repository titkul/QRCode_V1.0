...
address_congty = "104/6A1 Nhất Chi Mai, P.13, Q.Tân Bình, TP.HCM"
...
# Refresh function to make all check time of id in data to 0 for check many time
def refreshMap():
    for i in data:
        personIds[i['maNV']] = 0

# Run once time to create database
refreshMap()
...
class Thread(QThread):
    ...
    def run(self):
        ...
        self.threshold = 70
        self.color = (0,255,0)
        self.minsize = 400  # minimum size of face
                            ...
                            for barcode in barcodes:
                                ...
                                if len(datacheck) > 2:
                                    ...
                                    if len(texts[1]) != 0:
                                        ...
                                        t3_s = threading.Thread(target=self.soud4, args=(texts[1], ))
                                        t3_s.start()
                                        t5_s = threading.Thread(target=self.upload_info, args=(texts[0], self.timeDetect, self.temperature, ))
                                        t5_s.start()
                                        self.staffName = str(texts[1]) #getNameStudent((name2))
                                        self.position = "None" #getClassStudent(name2)
                                        self.staffMnv = "None" #getIDStudent(name2)
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.video.setGeometry(QtCore.QRect(20, 10, 720, 960))
        self.video.setMinimumSize(QtCore.QSize(720, 960))
        self.video.setMaximumSize(QtCore.QSize(720, 960))
        self.video.setText("")
        self.video.setScaledContents(True)

        self.logo.setGeometry(QtCore.QRect(760, 10, 91, 91))
        self.logo.setText("")
        self.logo.setPixmap(QtGui.QPixmap("Image/Logo_TitKul.png"))
        ...
        self.qrcode.setGeometry(QtCore.QRect(780, 780, 131, 131))
        self.qrcode.setPixmap(QtGui.QPixmap("Image/qrcongty.jpg"))
        self.qrcode.setText("")
        self.qrcode.setObjectName("qrcode")
        self.qrcode.setScaledContents(True)
        
        self.qr_yte.setGeometry(QtCore.QRect(930, 780, 141, 131))
        self.qr_yte.setPixmap(QtGui.QPixmap("Image/qryt.jpg"))
        self.qr_yte.setText("")
        ...
        self.address.setGeometry(QtCore.QRect(860, 70, 235, 50))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.company_name.setText(_translate("MainWindow", "TITKUL Company"))
